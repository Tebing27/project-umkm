    ...
    <div class="font-sans w-full bg-white overflow-hidden text-left pb-2">
        ...
        <div class="px-4 pt-3 pb-3 md:px-6 md:pt-5 md:pb-4">
            ...
            <div class="flex items-start gap-1 mt-2 text-gray-600">
                <svg class="w-4 h-4 md:w-5 md:h-5 shrink-0 text-black mt-[12px]" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
            ...
            <div
                ...
                <div
                    ...
                    <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer"
                        ...
                        <svg class="w-3.5 h-3.5 md:w-5 md:h-5 text-[#E4405F] shrink-0 transition-transform"
                ...
                <div
                    ...
                    <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer"
                        class="flex items-center gap-1.5 md:gap-2.5 overflow-hidden group cursor-pointer !text-black !font-normal">
                        <svg class="w-3.5 h-3.5 md:w-5 md:h-5 text-gray-800 shrink-0 transition-transform"
                ...
                <div
                    ...
                    <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer"
                        class="flex items-center gap-1.5 md:gap-2.5 overflow-hidden group cursor-pointer !text-black !font-normal">
                        <svg class="w-3.5 h-3.5 md:w-5 md:h-5 text-[#1877F2] shrink-0 transition-transform"
                            fill="currentColor" viewBox="0 0 24 24">
                            <path
                ...
                <div
                    ...
                    <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer"
                        class="flex items-center gap-1.5 md:gap-2.5 overflow-hidden group cursor-pointer !text-black !font-normal">
                        <svg class="w-3.5 h-3.5 md:w-5 md:h-5 text-black shrink-0 transition-transform"
                            fill="currentColor" viewBox="0 0 24 24">
                            <path
                ...
                <div
                    ...
                    <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer"
                        class="flex items-center gap-1.5 md:gap-2.5 overflow-hidden group cursor-pointer !text-black !font-normal">
                        <svg class="w-3.5 h-3.5 md:w-5 md:h-5 text-[#25D366] shrink-0 transition-transform"
                            fill="currentColor" viewBox="0 0 24 24">
                            <path
