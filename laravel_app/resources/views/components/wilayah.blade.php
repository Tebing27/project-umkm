<section class="py-12 bg-white overflow-hidden">
    ...
    >
        <h1 class="text-center lg:text-center text-3xl md:text-4xl lg:text-5xl font-bold text-black mb-8 lg:mb-16 tracking-tight">
            Wilayah
        </h1>
        ...
        <div class="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div class="w-full md:w-2/3 min-w-0"> 
                <div 
                    x-ref="slider"
                    class="flex gap-6 overflow-x-auto pb-8 pt-2 snap-x snap-mandatory scroll-smooth [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] -mx-4 px-4 sm:-mx-6 sm:px-6 lg:mx-0 lg:px-0"
                >
                    <template x-for="(item, index) in items" :key="index">
                        <div 
                            class="min-w-[260px] md:min-w-[320px] snap-center rounded-xl overflow-hidden flex flex-col transition-transform hover:scale-[1.02] duration-300 shadow-sm border border-gray-100/50"
                            :class="item.color"
                        >
                            ...
                            <div class="p-6 md:p-8 text-center flex flex-col items-center flex-grow bg-opacity-50">
                                ...
                                <a href="#" class="flex items-center gap-1 text-sm font-semibold text-gray-900 hover:text-black group mt-auto">
                                    Lihat Lokasi 
