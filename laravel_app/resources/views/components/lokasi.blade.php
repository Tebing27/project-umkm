        ...
        <div
                ...
                <div class="w-full h-auto md:h-full flex flex-col gap-3 p-4 md:p-6"
                    ...
                    <div class="md:hidden flex items-center gap-2 mt-2 w-full">
                        ...
                        <button @click="prevPage()" :disabled="currentPage === 1"
                            class="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#003366] shadow-lg border border-gray-100 active:scale-95 transition disabled:opacity-50 flex-shrink-0"><x-icons.svg
                                name="arrow-left" class="w-5 h-5" /></button>
                        <button @click="nextPage()" :disabled="currentPage === totalPages"
                            class="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#003366] shadow-lg border border-gray-100 active:scale-95 transition disabled:opacity-50 flex-shrink-0"><x-icons.svg
                                name="arrow-right" class="w-5 h-5" /></button>
                    </div>
                    ...
                    <div class="hidden md:flex justify-center gap-4 items-center pb-0 pt-2 mt-auto">
                        <button @click="prevPage()" :disabled="currentPage === 1"
                            class="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#003366] transition border border-gray-100 shadow-md disabled:opacity-50"><x-icons.svg
                                name="arrow-down" class="w-6 h-6 -rotate-180" /></button>
                        <span class="text-white text-xs font-bold tracking-wider"><span x-text="currentPage"></span> /
                            <span x-text="totalPages"></span></span>
                        <button @click="nextPage()" :disabled="currentPage === totalPages"
                            class="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#003366] transition border border-gray-100 shadow-md disabled:opacity-50"><x-icons.svg
                                name="arrow-down" class="w-6 h-6" /></button>
                    </div>

                    <div x-show="sidebarOpen"
                        class="md:hidden absolute -bottom-6.5 left-1/2 transform -translate-x-1/2 z-50 flex gap-2 items-center">
                        <button @click="sidebarOpen = false"
                            class="w-10 h-10 bg-[#FFC107] rounded-full flex items-center justify-center shadow-lg cursor-pointer hover:bg-yellow-400 text-[#003366] transition-transform hover:scale-105"><x-icons.svg
                                name="arrow-down" class="w-5 h-5 -rotate-180" /></button>
                    </div>
                </div>
            </div>
            ...
            <div class="relative flex-1 bg-gray-200 h-full w-full min-w-0">
                ...
                <div class="hidden md:flex absolute top-32 -left-4 z-50 transition-all duration-300"
                    ...
                    <button @click="sidebarOpen = false"
                        class="w-10 h-10 bg-[#FFC107] rounded-full flex items-center justify-center shadow-lg cursor-pointer hover:bg-yellow-400 text-[#003366] transition-transform hover:scale-110"><x-icons.svg
                            name="arrow-left" class="w-4.5 h-4.5" /></button>
                </div>
                ...
                <div
                    ...
                    <button @click="map.zoomIn()"
                        class="w-8 h-8 flex items-center justify-center text-gray-600 border-b hover:bg-gray-50 text-xl font-bold">+</button>
                    <button @click="map.zoomOut()"
                        class="w-8 h-8 flex items-center justify-center text-gray-600 hover:bg-gray-50 text-xl font-bold">-</button>
                </div>
            </div>
