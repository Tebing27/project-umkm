...
@else
    @php
        $baseClass =
            'w-full border text-slate-900 placeholder-gray-400 font-medium focus:outline-none transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed';
        ...
        $variants = [
            'default' =>
                'bg-gray-50 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary ' .
            ...
            'ghost' => 'bg-transparent hover:bg-gray-50 focus:bg-gray-100 border-none rounded-lg',
            'search' =>
                'bg-gray-50 outline-none focus:bg-white rounded-xl border-gray-300 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500',
