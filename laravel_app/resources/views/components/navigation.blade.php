<header class="absolute top-0 left-0 w-full z-10">
 <div class="mx-auto max-w-7xl px-4 md:px-6 lg:px-10 pt-4">
    <nav class="relative flex w-full items-center justify-between rounded-lg bg-white p-3 md:p-4 shadow-md md:rounded-2xl">

      <a href="#" class="shrink-0 inline-flex items-center gap-4">
        <span class="text-4xl md:text-3xl font-bold text-slate-900">Logo</span>
      </a>
      ...
      <div class="hidden md:flex shrink-0 items-center space-x-2 md:space-x-3 lg:space-x-4">
        ...
        <div class="relative" x-data="{ open: false }">
          <button @click="open = !open"
            ...
            <img src="https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/3.5.0/flags/4x3/id.svg" alt="ID"
          ...
          <div x-show="open" @click.away="open = false"
            ...
            <a href="#"
              class="flex items-center space-x-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md">
              <img src="https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/3.5.0/flags/4x3/gb.svg" alt="EN"
                class="w-5 h-5 rounded-full object-cover">
        ...
        <a href="#" class="bg-yellow-400 text-black lg:px-7 lg:py-3 rounded-lg font-reguler text-xl hover:bg-yellow-500 md:py-2 md:px-6">
          Daftar
        </a>
      </div>
      ...
      <div class="md:hidden" x-data="{ open: false }">
        ...
        <button @click="open = !open" class="inline-flex p-2 rounded-md text-slate-800">
          ...
          <svg x-show="open" style="display: none;" class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div x-show="open" @click.away="open = false" @scroll.window="open = false"
            ...
            x-transition:leave-start="opacity-100 transform scale-100"
            x-transition:leave-end="opacity-0 transform scale-95"
          class="absolute top-18 right-0 w-52 z-50"
          style="display: none;">
          <div class="rounded-xl bg-white shadow-lg p-6 space-y-0.5 text-center">

            <a href="#" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-50">
              Beranda
            </a>
            <a href="#" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-50">
              Wilayah
            ...
            <div x-data="{ langOpen: false }" class="mb-4 mt-4">
              <button @click="langOpen = !langOpen"
                ...
                <span class="flex items-center space-x-2">
                  <img src="https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/3.5.0/flags/4x3/id.svg" alt="ID" class="w-5 h-5 rounded-full object-cover">
                  <span>ID</span>
                </span>
              ...
              <div x-show="langOpen" x-transition class="pl-5 pt-2 space-y-2 text-center">
                 <a href="#" class="flex items-center space-x-2 px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md">
                    <img src="https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/3.5.0/flags/4x3/id.svg" alt="ID" class="w-5 h-5 rounded-full object-cover">
                    <span>Indonesia (ID)</span>
                 </a>
                 <a href="#" class="flex items-center space-x-2 px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md">
                    <img src="https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/3.5.0/flags/4x3/gb.svg" alt="EN" class="w-5 h-5 rounded-full object-cover">
                    <span>English (EN)</span>
                 </a>
              </div>
            </div>
