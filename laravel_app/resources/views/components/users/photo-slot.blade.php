...
<div class="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.06)] border border-gray-100 transition-all duration-300 group/card"
    ...
    {{-- Upload Area --}}
    <div class="relative w-full aspect-[4/3] rounded-xl overflow-hidden bg-slate-50 border-2 border-dashed border-gray-200 hover:border-[#004a85] hover:bg-blue-50/30 transition-all cursor-pointer group/upload"
        ...
        {{-- Placeholder --}}
        <div class="absolute inset-0 flex flex-col items-center justify-center text-gray-400 group-hover/upload:text-[#004a85] transition-colors p-4"
            x-show="!photoPreview">
            <div
    ...
    <div class="flex items-center gap-3 mt-4 pt-4 border-t border-gray-50">
        ...
        <div class="flex-1">
            <x-ui.input variant="default" size="sm" type="number"
                ...
                max="5"
                class="w-full max-w-[80px] text-center font-bold text-gray-700 !py-1.5" />
        </div>
    </div>
