            ...
            <form action="#" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-1.5">
                        ...
                        <x-ui.input variant="soft" type="text" placeholder="Contoh: Makaroni Kering"
                    ...
                    <div class="space-y-1.5">
                        ...
                        <x-ui.input variant="soft" type="number" placeholder="25.000" class="text-sm md:text-base">
                            <x-slot:icon>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-1.5">
                        <label class="block text-sm font-bold text-slate-700">Kategori Produk <span
                                class="text-red-500">*</span></label>
                        <x-ui.input variant="soft" type="text" placeholder="Makanan" class="text-sm md:text-base">
                        </x-ui.input>
                    </div>
                </div>
            </form>
