<div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-16 lg:mb-24 mt-8">
    ...
    <div class="flex flex-col justify-center pt-4">
        ...
        <p class="text-slate-500 mb-10 max-w-md">Temukan umkm sasuma yang ingin kamu kunjungi disetiap
            wilayah
        </p>
                ...
                <div class="flex-1">
                    <div class="relative group h-full">
                        ...
                        <div class="flex-1 h-full">
                            <x-ui.input variant="transparent" x-model="searchQuery" placeholder="Cari nama toko"
                    ...
                    <x-ui.button variant="trigger" size="compact" @click="open = !open" type="button"
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="truncate max-w-[150px] text-sm"
                                x-text="selectedLocation || 'Semua Wilayah'"></span>
                        </div>
                    ...
                    <div x-show="open" x-transition.origin.top x-cloak
                        ...
                        <template x-for="loc in ['Semua', 'Pengasinan', 'Sawangan', 'Bojongsari']">
                            <div @click="selectedLocation = (loc === 'Semua' ? '' : loc); open = false"
                                ...
                                <span x-text="loc === 'Semua' ? 'Semua Wilayah' : loc"></span>
                                <x-icons.check x-show="selectedLocation === (loc === 'Semua' ? '' : loc)"
            ...
            <div class="flex md:hidden items-center gap-3 mt-4 relative z-20">
                ...
                <div class="relative shrink-0" x-data="{ open: false }" @click.outside="open = false">
                    ...
                    <x-ui.button variant="filter" size="default" @click="open = !open"
                        ...
                        <span x-text="selectedLocation || 'Wilayah'"></span>
