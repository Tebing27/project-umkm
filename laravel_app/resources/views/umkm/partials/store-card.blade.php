<x-ui.card
    ...
    <div class="flex items-start gap-4 mb-4">
        ...
        <div class="flex-1 min-w-0">
            ...
            <h3 class="text-xl font-bold text-slate-900 group-hover:text-primary transition-colors truncate"
                x-text="item.name"></h3>
        </div>
    </div>
    ...
    <div class="flex justify-center text-base items-center">
        <x-ui.button x-bind:href="item.link" variant="link" size="icon-link">
            {{translate('Lihat Toko')}}
            <x-icons.ui-area-right class="w-4 h-4" />
        </x-ui.button>
    </div>
</x-ui.card>
