<div class="hidden lg:block relative h-[400px] lg:h-[500px] w-full rounded-3xl overflow-hidden shadow-2xl shadow-primary/20 order-1 lg:order-2 group">
    <img src="{{ ($contents['umkm_index_banner']->value ?? null) ? asset('storage/' . str_replace('\\', '/', $contents['umkm_index_banner']->value)) : 'https://images.unsplash.com/photo-1542838132-92c53300491e?q=80&w=2574&auto=format&fit=crop' }}"
