                 ...
                 <div class="relative shrink-0" x-data="{ open: false }" @click.outside="open = false">
                    <x-ui.button variant="filter" size="default" @click="open = !open"
                     ...
                     <div x-show="open" x-transition.origin.top.left x-cloak
                        class="absolute top-full left-0 mt-2 w-56 bg-white rounded-xl shadow-xl shadow-slate-200/50 border border-gray-100 z-50 overflow-hidden py-1">
                        <div @click="selectedLocation = ''; open = false"
                            class="px-4 py-3 text-sm font-medium text-slate-600 hover:bg-gray-50 hover:text-primary cursor-pointer flex items-center justify-between transition-colors">
