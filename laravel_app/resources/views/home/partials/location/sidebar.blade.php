...
<div class="absolute top-0 left-0 md:relative z-30 bg-brand-navy transition-all duration-500 ease-in-out flex-shrink-0 w-full md:h-full shadow-2xl md:shadow-none"
    ...
    <div class="w-full h-auto md:h-full flex flex-col gap-3 p-4 md:p-6"
        ...
        @include('home.partials.location.sidebar-search-filter', ['regions' => $regions])

        @include('home.partials.location.sidebar-mobile-section')

        @include('home.partials.location.sidebar-desktop-list')

        @include('home.partials.location.sidebar-desktop-pagination')
