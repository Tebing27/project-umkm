...
<div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
    <div class="flex items-center gap-6">
        <div class="w-20 h-20 rounded-full bg-slate-200 flex items-center justify-center text-slate-500 font-bold text-2xl border-4 border-white shadow-lg overflow-hidden">
        ...
        @if (!$shop->is_verified)
            ...
            @else
                <div class="group relative inline-block">
                    <x-ui.button type="button" disabled class="bg-gray-200 text-gray-500 rounded-lg cursor-not-allowed font-semibold w-full">
                        {{ translate('Verifikasi Sekarang') }}
                    </x-ui.button>
